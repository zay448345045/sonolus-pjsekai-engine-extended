...
export const skin = defineSkin({
    sprites: {
        ...
        criticalArrowUp1: 'Sekai Flick Yellow Arrow Up 1',
        criticalArrowUp2: 'Sekai Flick Yellow Arrow Up 2',
        criticalArrowUp3: 'Sekai Flick Yellow Arrow Up 3',
        criticalArrowUp4: 'Sekai Flick Yellow Arrow Up 4',
        criticalArrowUp5: 'Sekai Flick Yellow Arrow Up 5',
        criticalArrowUp6: 'Sekai Flick Yellow Arrow Up 6',
        criticalArrowLeft1: 'Sekai Flick Yellow Arrow Left 1',
        criticalArrowLeft2: 'Sekai Flick Yellow Arrow Left 2',
        criticalArrowLeft3: 'Sekai Flick Yellow Arrow Left 3',
        criticalArrowLeft4: 'Sekai Flick Yellow Arrow Left 4',
        criticalArrowLeft5: 'Sekai Flick Yellow Arrow Left 5',
        criticalArrowLeft6: 'Sekai Flick Yellow Arrow Left 6',
        ...
        guideGreenFallback: SkinSpriteName.SimultaneousConnectionGreen,
        guideYellow: 'Sekai+ Guide Yellow',
        guideYellowFallback: SkinSpriteName.SimultaneousConnectionYellow,
        guideRed: 'Sekai+ Guide Red',
        guideRedFallback: SkinSpriteName.SimultaneousConnectionRed,
        guidePurple: 'Sekai+ Guide Purple',
        guidePurpleFallback: SkinSpriteName.SimultaneousConnectionPurple,
        guideCyan: 'Sekai+ Guide Cyan',
        guideCyanFallback: SkinSpriteName.SimultaneousConnectionCyan,
        guideBlue: 'Sekai+ Guide Blue',
        guideBlueFallback: SkinSpriteName.SimultaneousConnectionBlue,
        guideNeutral: 'Sekai+ Guide Neutral',
        guideNeutralFallback: SkinSpriteName.SimultaneousConnectionNeutral,
